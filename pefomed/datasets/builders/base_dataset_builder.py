...
import pefomed.common.utils as utils
import torch.distributed as dist
from pefomed.common.dist_utils import is_dist_avail_and_initialized, is_main_process
from pefomed.common.registry import registry
from pefomed.datasets.data_utils import extract_archive
...
class BaseDatasetBuilder:
    ...
    def build(self):
        ...
        build_info = self.config.build_info # json&image location yaml
        ...
        for split in ann_info.keys():
            ...
            vis_path = vis_info.storage # /mnt/sda/lpf/data/medical/vqa/data_RAD/images/
