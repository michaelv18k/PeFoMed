...
class ModelBase(BaseModel):
    ...
    def init_llm(
        self, 
        llama_model_path="/kaggle/input/llama-model",  # Path to your downloaded model
        low_resource=True, 
        low_res_device=0, 
        lora_r=8,
        lora_target_modules=["q_proj", "v_proj"], 
        **lora_kargs
        ...
        llama_tokenizer = LlamaTokenizer.from_pretrained("HuggingFaceH4/zephyr-7b-alpha", use_fast=False)
        llama_tokenizer.pad_token = "$$"
